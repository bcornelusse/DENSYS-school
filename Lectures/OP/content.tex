...
\begin{frame} {Lecture objectives}
    \begin{itemize}
        \item Why do we have to plan the operations?
        \item Formulate the operational planning optimization problem
        ...
        \item Understand the interest of good forecasting techniques
    \end{itemize}
\end{frame}
...
\begin{frame}
    \frametitle{Reminder: control levels}

    \begin{table}[h!]
        \centering
        \begin{tabular}{|c|c|c|}
        \hline
        \textbf{Level} & \textbf{Function} & \textbf{Examples} \\ \hline
        1 & Device level control & BSS control, reactive control \\ \hline
        2 & Local area control & Frequency regulation, fast load shedding \\ \hline
        3 & Supervisory control & Forecasting, operational planning \\ \hline
        4 & Public Grid interaction & Ancillary services, energy markets \\ \hline
        \end{tabular}
        \caption{Control Levels and Their Corresponding Functions and Examples}
        \label{tab:control_levels}
    \end{table}

    We will be mainly focused on levels 3 and 4.

\end{frame}

\begin{frame}
    \frametitle{Level 3: supervisory control}
    \begin{itemize}
...
\begin{frame}
    \frametitle{Level 4: interaction with the outside world}
    \begin{itemize}
...
\begin{frame}
    \frametitle{When are operation decisions taken?}
\begin{itemize}
    ...
    \item Human activity has weekly and seasonal periodicity
    \item Storage, heating, EV demands create time coupling constraints
    \end{itemize}
\end{itemize}
\end{frame}

\begin{frame}
    \frametitle{Operational planning decision horizon $T$}

    We cannot take preventive operation decisions too much in advance:
    \begin{itemize}
...
\begin{frame}
    \frametitle{Operational planning decision duration $\Delta_t$}

    \begin{itemize}
        \item For computational reasons, we \textbf{discretize} the decisions in time.
