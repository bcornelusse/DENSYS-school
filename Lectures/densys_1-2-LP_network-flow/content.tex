...
\begin{itemize}
	...
	\item Are there some “loop flows”? How could you avoid them?
\end{itemize}

\textbf{Sensitivity analysis.} for all the cases below, think first about the expected solution and check the solver results. Is the problem infeasible for some values? How does the cost function evolve? 
\begin{itemize}
