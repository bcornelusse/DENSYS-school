...
% Document metadata
\title{\normalsize Introduction to optimization -- linear programming }
\subtitle{\tiny Optimization and machine learning applied to microgrid optimal control, optimal design, and forecasting}
...
\usetheme[titlestyle=style2]{trigon}
